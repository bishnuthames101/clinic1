...
const BASE_IMAGE_URL = 'https://raw.githubusercontent.com/12Bishnu/kist-clinic-/main/';
...
export const testPackages: TestPackage[] = [
  {
    ...
    turnaroundTime: 'Same Day',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'basic_full_body_checkup.jpg',
  ...
  },
  {
    ...
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'premium_full_body_checkup.jpg',
    category: 'Full Body Checkup',
  ...
  },
  {
    ...
    turnaroundTime: '24 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'diabetes_profile_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '24 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'advance_diabetes_profile.jpg',
    category: 'Diabetes & Metabolic',
  ...
  },
  {
    ...
    turnaroundTime: '24 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'heart_health_package.jpg',
  ...
  },
  {
    ...
    image: BASE_IMAGE_URL + 'female_hormone_test.jpg',
  ...
  },
  {
    ...
    image: BASE_IMAGE_URL + 'male_hormone_test.jpg',
    category: 'Hormone & Wellness',
  ...
  },
  {
    ...
    turnaroundTime: '48 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'female_premarriage_test_package.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '48 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'male_premarriage_test_package.jpg',
    category: 'Premarital Screening',
  ...
  },
  {
    ...
    turnaroundTime: '48 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'pcos_pcod.jpg',
    category: 'Hormone & Wellness',
  ...
  },
  {
    ...
    description: 'Comprehensive fertility assessment for couples planning pregnancy',
    price: 4500,
    tests: ['FSH', 'LH', 'Estradiol', 'Progesterone', 'Prolactin', 'AMH', 'TSH', 'Vitamin D'],
    turnaroundTime: '48 Hours',
    requirements: 'Specific cycle day testing may be required',
    image: BASE_IMAGE_URL + 'fertility_panel_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '48 Hours',
    requirements: 'No special preparation needed',
    image: BASE_IMAGE_URL + 'STI_detection.jpg',
  ...
  },
  {
    ...
    requirements: 'No special preparation needed',
    image: BASE_IMAGE_URL + 'advance_STI_detection.jpg',
    category: 'Infectious Disease',
  ...
  },
  {
    ...
    description: 'Multi-organ cancer marker screening for early detection',
    price: 6500,
    tests: ['CEA', 'CA 19-9', 'CA 125', 'PSA (Males)', 'AFP', 'CBC', 'Liver Function', 'Kidney Function'],
    turnaroundTime: '48 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'cancer_screening_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '24 Hours',
    requirements: 'Morning sample preferred',
    image: BASE_IMAGE_URL + 'iron_profile_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '48 Hours',
    requirements: 'No special preparation needed',
    image: BASE_IMAGE_URL + 'arthritis_panel_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '72 Hours',
    requirements: 'No special preparation needed',
    image: BASE_IMAGE_URL + 'food_allergy_panel_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '72 Hours',
    requirements: 'No special preparation needed',
    image: BASE_IMAGE_URL + 'inhalation_allergy_panel_test.jpg',
    category: 'Allergy Testing',
  ...
  },
  {
    ...
    description: 'Comprehensive assessment for hair loss and scalp health',
    price: 3500,
    tests: ['Vitamin D', 'Vitamin B12', 'Ferritin', 'Thyroid Profile', 'Testosterone', 'DHEAS', 'Zinc', 'Complete Blood Count'],
    turnaroundTime: '48 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'hairfall_screening_test.jpg',
  ...
  },
  {
    ...
    turnaroundTime: '48 Hours',
    requirements: '12 hours fasting required',
    image: BASE_IMAGE_URL + 'smokers_wellness_panel_test.jpg',
